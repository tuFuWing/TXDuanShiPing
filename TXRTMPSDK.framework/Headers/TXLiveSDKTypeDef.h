...
VIDEO_RESOLUTION_TYPE_180_320 = 0,
VIDEO_RESOLUTION_TYPE_270_480 = 1,
VIDEO_RESOLUTION_TYPE_360_640 = 2,
VIDEO_RESOLUTION_TYPE_540_960 = 3,
VIDEO_RESOLUTION_TYPE_720_1280 = 4,
VIDEO_RESOLUTION_TYPE_320_180 = 5,
VIDEO_RESOLUTION_TYPE_480_270 = 6,
VIDEO_RESOLUTION_TYPE_640_360 = 7,
VIDEO_RESOLUTION_TYPE_960_540 = 8,
VIDEO_RESOLUTION_TYPE_1280_720 = 9,
VIDEO_RESOLUTION_TYPE_320_480 = 10,   // 连麦专用，采用固定码率。
};
...
typedef NS_ENUM(NSInteger, TX_Enum_Type_VideoQuality) {
    VIDEO_QUALITY_QOS_DEFINITION            = 0,      //带宽自适应：动态切换分辨率和码率适应带宽，200kbps~1500kbps。
